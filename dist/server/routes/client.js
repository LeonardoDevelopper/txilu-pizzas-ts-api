...
function client_routes() {
    ...
    server_1.Server.routes().put('/client/inserts/create-account', (req, res) => __awaiter(this, void 0, void 0, function* () {
        const { firstname, lastname, email, phone, password } = req.body.data;
        const dbResponse = yield client.create.account(firstname, lastname, email, phone, password);
        //res.json(dbResponse)
    }));
}
