...
function relationships() {
    const [ADMIN, ADMIN_LOCATION, CART, CATEGORY, CLIENT, DELIVER, DELIVER_LOCATION, DELIVER_RATE, FAVORITE_DEVLIVER, ORDER_ITEMS, ORDER, PIZZA, LOCAL_DELIVERY, FAVORITE_PIZZA, PIZZA_RATE, CAR] = server_1.Server.getDatabaseTables();
